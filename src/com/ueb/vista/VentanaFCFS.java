...
public class VentanaFCFS extends JFrame implements ActionListener
{
	...
	public static final String TITULO = "Algoritmo FCFS (FIFO)";
	...
	public VentanaFCFS(VentanaPrincipal pVentanaP)
	{
