...
import com.ueb.modelo.Srtf;

public class VentanaSRTF extends JFrame implements ActionListener
{
	/**
	 * 
	 */
	...
	// ---------------------------------------------------------------------------------------------------
		...
		public static final String TITULO = "Algoritmo SRTF";
		...
		public VentanaSRTF(VentanaPrincipal pVentanaP)
		{
