...
import com.ueb.modelo.Sjf;


public class VentanaSJF extends JFrame implements ActionListener
{
	/**
	 * 
	 */
	...
	// ---------------------------------------------------------------------------------------------------
		...
		public static final String TITULO = "Algoritmo SJF";
		...
		public VentanaSJF(VentanaPrincipal pVentanaP)
		{
